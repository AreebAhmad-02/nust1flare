...
def main() -> None:
    ...
    ap.add_argument("--out_json", type=Path, default=None,
                    help="Destination directory json for processed test json "
                         "(default: nothing")
    args = ap.parse_args()
    ...
    json_out = args.out_json / (args.json_in.stem + "_processed.json")
    # json_out = args.out_json.with_name(args.out_json.stem + "_processed.json")
